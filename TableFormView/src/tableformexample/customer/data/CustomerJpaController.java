 ...
 * @author abouis
 */
public class CustomerJpaController implements Serializable, BeanDao<Customer> {
    ...
    public List<Customer> retrieve() {
        List<Customer> resultList = findCustomerEntities();
        return resultList;
    }
    ...
    @Override
    public void remove(Customer bean) throws Exception {
        destroy(bean.getCustomerId());
    }
